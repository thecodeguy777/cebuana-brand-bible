    ...
    <div class="drawer-side">
      ...
      <aside :class="['bg-base-200 min-h-full transition-all duration-300 ease-in-out', isCollapsed ? 'w-20' : 'w-80']">
        ...
        <ul :class="['menu w-full py-2 space-y-1', isCollapsed ? 'px-2' : 'px-4']">
          ...
          <li>
            <router-link to="/banking-landing" :class="isCollapsed ? 'tooltip tooltip-right px-0 justify-center' : 'gap-4'" :data-tip="isCollapsed ? 'Banking Landing' : ''" active-class="active">
              <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/>
              </svg>
              <span v-if="!isCollapsed">Banking Landing</span>
            </router-link>
          </li>
          ...
          <li>
            <router-link to="/scroll-demo" :class="isCollapsed ? 'tooltip tooltip-right px-0 justify-center' : 'gap-4'" :data-tip="isCollapsed ? 'Scroll Animations' : ''" active-class="active">
              <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M9 19l3 3m0 0l3-3m-3 3V10"/>
              </svg>
              <span v-if="!isCollapsed">Scroll Animations</span>
            </router-link>
          </li>
          <li>
            <router-link to="/advanced-scroll" :class="isCollapsed ? 'tooltip tooltip-right px-0 justify-center' : 'gap-4'" :data-tip="isCollapsed ? 'Advanced Effects' : ''" active-class="active">
              <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"/>
              </svg>
              <span v-if="!isCollapsed">Advanced Effects</span>
            </router-link>
          </li>
        </ul>
